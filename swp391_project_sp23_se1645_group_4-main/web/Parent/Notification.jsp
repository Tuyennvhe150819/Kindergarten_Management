                    ...
                    <div class="row" style="padding: 0; margin: 0;">
                        <div class="col-12 " style="padding: 0; margin: 0;">
                            ...
                            <div style="position: absolute; top: 45%;left: 45%;">
                                <h1 style="color: #fff;font-weight: 600;">Notification</h1>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="container">
                <div class="row">
                    <c:forEach items="${note}" var="n">
                        <div class="col-12 d-flex" style="border-bottom: 3px dotted gray;padding-bottom: 30px;">
                            <div class="col-4">
                                <img style="width: 100%;border-radius: 10px;" src="img/${n.notImg}" >
                            </div>
                            <div class="col-8">
                                <h4>${n.subject}</h4>
                                ...
                                <span style="color: #EB1551;;">Read More</span>
                                <p style="margin-top: 30px;margin-bottom: 50px;">
                                    Createby: ${n.createBy}
                                </p>
                            </div>
                ...
                <div class="content__paging col-12 d-flex justify-content-center">
                    <ul>
                        <c:if test="${numPage > 1}">
                            <li><a class="fas fa-angle-left" href="NotificationController?index=${numPage-1}"></a></li>
                            </c:if>

                        <div class="number-page" id="number-page">
                            <c:forEach begin="1" end="${endPage}" var="i">
                                <li class="${numPage == i ? "active":""}"><a href="NotificationController?index=${i}">${i}</a></li>
                                </c:forEach>                                                           
                        </div>
                        <c:if test="${numPage < endPageAccount}">
                            <li><a class="fas fa-angle-right" href="NotificationController?index=${numPage+1}"></a></li>
                            </c:if>
                    </ul>
                </div>
            </div>
