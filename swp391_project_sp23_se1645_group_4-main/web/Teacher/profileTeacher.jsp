                                            ...
                                            <div class="col-10" style="padding-left: 50px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="firstname" type="text" class="form-control form-control-lg"
                                                           placeholder="Username" aria-label="Username" value="${sessionScope.teach.teacherFirstName}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Last Name</label>
                                                    <input name="lastname" type="text" class="form-control form-control-lg"
                                                           placeholder="Username" aria-label="Username" value="${sessionScope.teach.teacherLastName}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Phone</label>
                                                    <input name="phone" type="number" class="form-control form-control-lg"
                                                           placeholder="Username" aria-label="Phone" value="${sessionScope.teach.phone}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Brithday</label>
                                                    <input name="date" type="date" class="form-control form-control-lg"
                                                           placeholder="Username" aria-label="Username" value="${sessionScope.teach.birthdate}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input name="address" type="text" class="form-control form-control-lg"
                                                           placeholder="Username" aria-label="Username" value="${sessionScope.teach.address}" readonly>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12" style="margin-top: 50px;margin-bottom: 50px;">
                                                        <a type="submit" class="btn btn-dark btn-icon-text" href="updateProfileTeach">
                                                            Edit
