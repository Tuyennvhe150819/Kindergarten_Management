                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <form action="CreateNotiAD" method="POST" id="formNotification">
                                        <div class="card-body container">
                                            <div class="row">
                                                ...
                                                <div class="col-10" style="padding-left: 50px;">
                                                    <h2 style="color: black;margin-top: 50px;margin-bottom: 30px;">Create Notification
                                                    </h2>
                                                    <div class="form-group">
                                                        <label>Subject</label>
                                                        <input name="subject" type="text" class="form-control form-control-lg" id="subject"
                                                               aria-label="subject">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="describe" id="describe"
                                                                  class="form-control form-control-lg" placeholder="Write your message here..."></textarea>
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="createBy" id="createBy" type="text" class="form-control form-control-lg">
                                                        <span class="form-message"></span>
                                                    </div>
