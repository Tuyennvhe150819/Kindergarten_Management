                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="teacherID" class="form-control form-control-lg">
                                                            <c:forEach items="${teacher}" var="t">
                                                                <option value="${t.teacherID}" ${class.teacherID == t.teacherID ?'selected' : ''}>${t.teacherLastName} ${t.teacherFirstName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="termID" class="form-control form-control-lg">
                                                            <c:forEach items="${terms}" var="tm">
                                                                <option value="${tm.termID}" ${class.termID == tm.termID ?'selected' : ''}>${tm.termName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
