                        ...
                        <div class="content-wrapper">
                            <div class="row">
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <form action="UpdateTermAdmin" method="POST" id="formTerm">
                                            <div class="card-body container">
                                                <div class="row">    
                                                    <input name="tid" value="${term.termID}" hidden>
                                                <div class="col-10" style="padding-left: 50px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="name" type="text" class="form-control form-control-lg"
                                                               value="${term.termName}" id="name">
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Start Day </label>
                                                        <input name="startD" type="date" value="${term.startdate}" class="form-control" id="startD" placeholder="dd/mm/yyyy">
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>End Day</label>
                                                        <input name="endD" type="date" value="${term.enddate}" class="form-control" id="endD" placeholder="dd/mm/yyyy">
                                                        <span class="form-message"></span>
                                                    </div>
