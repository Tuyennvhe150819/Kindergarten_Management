                        ...
                        <div class="content-wrapper">
                            <div class="row">
                                <div class="col-lg-12 grid-margin stretch-card">
                                    <div class="card">
                                        <form action="UpdateEventAdmin" method="POST" id="formEvent">
                                            <div class="card-body container">
                                                <div class="row">
                                                    <div class="imageBox col-2" style="margin-top: 50px;">
                                                        <img style="width: 100%;border-radius: 50%;"
                                                             src="images/faces/${event.eventImg}">
                                                    <div class="round3">
                                                        <input name="image" type="file">
                                                        <i style="color: #fff;" class="bi bi-camera"></i>
                                                    </div>
                                                    <input name="eid" value="${event.eventID}" hidden> 
                                                </div>
                                                <div class="col-10" style="padding-left: 50px;">
                                                    <h2 style="color: black;margin-top: 50px;margin-bottom: 30px;">Update Event
                                                    </h2>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="startEvent" type="date" value="${event.dayStartEvent}"
                                                               class="form-control" id="startEvent" placeholder="dd/mm/yyyy">
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>End Event</label>
                                                        <input name="endEvent" type="date" value="${event.dayEndEvent}"
                                                               class="form-control" id="endEvent" placeholder="dd/mm/yyyy">
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Organizational Sponsor</label>
                                                        <input name="organizationalSponsor" type="text" 
                                                               value="${event.organizationalSponsor}" id="organizationalSponsor" class="form-control form-control-lg">
                                                        <span class="form-message"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ClassId" class="form-control form-control-lg">
                                                            <c:forEach items="${class}" var="c">
                                                                <option value="${c.classID}"  ${event.classID == c.classID ?'selected' : ''}>${c.className}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
